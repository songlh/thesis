...
\newcommand{\codefig}[1]{%
  \centering
  \mbox{\lstinputlisting[basicstyle=\ttfamily\footnotesize ]{figures/#1.c}}}
...
%\input{chapter-cci/main}
%\input{chapter-afix/main}
%\input{chapter-cfix/main}
%\input{chapter-petri-net/main}
